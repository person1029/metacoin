...
{
    LogPrintf("MetacoinMiner started\n");
    ...
    try { while (true) {
        ...
        LogPrintf("Running MetacoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("MetacoinMiner terminated\n");
        throw;
    }
}
