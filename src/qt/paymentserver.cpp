...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click metacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start metacoin: click-to-pay handler");
    else
...
{
    // clicking on metacoin: URLs creates FileOpen events on the Mac:
