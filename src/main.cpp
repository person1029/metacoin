...
uint256 hashGenesisBlock("0x00000faa128fff142acdcabf506d0ba97391e56302e98b218c203e2c76cd244e"); // Original: 0x00000155e23d6175ab090be2cda018da0960f906d24dadf47bb98c705db345cd
...
const string strMessageMagic = "Metacoin Signed Message:\n";
...
static const int64 nBlockRewardStartCoin = 100 * COIN; //start
 ...
 */
  ...
  int64 nSubsidy = nBlockRewardStartCoin;
    ...
    // Subsidy is cut in half every 80000 blocks (23 days)
...
bool CBlock::ConnectBlock(CValidationState &state, CBlockIndex* pindex, CCoinsViewCache &view, bool fJustCheck)
{
    ...
    if (GetHash() == hashGenesisBlock) {  //(GetHash() == hashGenesisBlock)
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000faa128fff142acdcabf506d0ba97391e56302e98b218c203e2c76cd244e");// Original: 0x0000040828aa2f24614a69e463f4bf45dddda0b0b9fdde09c579cc109b4b3b17
    }
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "11,15,2016 M"; //Original: "2,4,2014 M";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 112;
        block.nTime    = 1479241495; // Original: 1391789585;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1143548;

        if (fTestNet)
        {
            block.nTime    = 1479241539; //Original: 1391789585;
            block.nNonce   = 4188068 ; //Original: 3327111
        }
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x16452e690046e5b5ae7c43e7637b756684c74697345883cd20bbb863befcb7ae"));  // //Original: 0x6291c034b880ede4ceaf2fc74ebf14cb7faa681d98bc92ddc4a456bbb60ba572

        //genesis block
        if (false && block.GetHash() != hashGenesisBlock) // Original: false
            {
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MetacoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MetacoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("MetacoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("metacoin-miner");
    ...
    try { while(true) {
        ...
        printf("Running MetacoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("MetacoinMiner terminated\n");
        throw;
    }
}
